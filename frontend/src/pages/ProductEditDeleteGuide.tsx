  ...
  return (
    <main className='flex-1 px-4 sm:px-10 lg:px-20 py-16 lg:py-24'>
      <article className='max-w-4xl mx-auto prose lg:prose-xl'>
        <h1>Ekobol'de Ürünleri Düzenleme ve Silme</h1>
        <p>
          Ekobol, tüm bağlı pazar yerlerinizdeki ürün listelemelerinizi merkezi
          bir konumdan kolayca yönetmenizi sağlar...
        </p>
