...
const OptimizePricingWithAiGuide = () => {
  return (
    <main className='flex-1 px-4 sm:px-10 lg:px-20 py-16 lg:py-24'>
      <article className='max-w-4xl mx-auto prose lg:prose-xl'>
        <h1>Ekobol'de Fiyatlandırmanızı Yapay Zeka ile Optimize Etme</h1>
        <p>
          Rekabetçi e-ticaret dünyasında, doğru fiyatlandırma stratejisi
          belirlemek satışlarınızı ve kârlılığınızı önemli ölçüde
          etkileyebilir...
        </p>
...
export default OptimizePricingWithAiGuide;
