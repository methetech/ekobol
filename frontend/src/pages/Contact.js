        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-4">
              <svg
                className="h-6 w-6 text-accent-primary mt-1 flex-shrink-0"
              ...
              <div>
                ...
                <a href="mailto:hello@ekobol.com" className="text-accent-primary font-medium hover:underline">
                  hello@ekobol.com
                </a>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:partner@ekobol.com" className="text-accent-primary font-medium hover:underline">
                  partner@ekobol.com
                </a>
              </div>
            </div>
          ...
          <div className="rounded-lg border border-void-secondary dark:border-white/10 p-8 bg-void-secondary dark:bg-black/20">
            <form className="space-y-6">
              <div>
                ...
                <input
                  className="mt-1 block w-full rounded-md bg-void-primary border-void-secondary dark:border-white/20 shadow-sm focus:border-accent-primary focus:ring-accent-primary"
                  id="name"
                  type="text"
                  required
                />
              ...
              <div>
                <label className="text-sm font-medium text-text-primary" htmlFor="contact-email">
              ...
              <div>
                <button
                  className="w-full flex justify-center py-3 px-4 rounded-full bg-accent-primary text-void-primary font-bold shadow-lg hover:bg-accent-primary-dark transition-shadow duration-300"
                  type="submit"
                >
