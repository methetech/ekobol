  ...
  return (
    <main className='flex-1 px-4 sm:px-10 lg:px-20 py-16 lg:py-24'>
      <article className='max-w-4xl mx-auto prose lg:prose-xl'>
        <h1>YZ Görüntü Oluşturucu Nasıl Kullanılır?</h1>
        <p>
          Ekobol'ün YZ Görüntü Oluşturucusu, ürün fotoğraflarınızı profesyonel,
          pazaryeri uyumlu görsellere dönüştürmek için tasarlanmış güçlü bir
          araçtır...
        </p>
...
export default AiImageGeneratorGuide;
