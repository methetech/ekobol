...
const UnderstandingDashboardGuide = () => {
  return (
    <main className='flex-1 px-4 sm:px-10 lg:px-20 py-16 lg:py-24'>
      <article className='max-w-4xl mx-auto prose lg:prose-xl'>
        <h1>Ekobol Kontrol Panelini Anlama</h1>
        <p>
          Ekobol kontrol paneli, e-ticaret imparatorluğunuzun merkezi sinir
          sistemidir...
        </p>
...
export default UnderstandingDashboardGuide;
